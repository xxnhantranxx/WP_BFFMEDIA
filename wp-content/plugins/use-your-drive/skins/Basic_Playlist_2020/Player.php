...
class Basic_Playlist_2020 extends MediaplayerSkin
{
    ...
    public function load_scripts($dependency = [])
    {
        ...
        wp_register_script('UseyourDrive.Basic_Playlist.Player', $this->get_url().'/js/Player.js', ['WPCloudPlugins.Polyfill', 'Basic_Playlist.Library', 'WPCloudPlugins.Libraries'], USEYOURDRIVE_VERSION, true);
