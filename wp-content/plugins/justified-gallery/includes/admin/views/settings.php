...
<div class="wrap<?php echo ! dgwt_freemius()->is_premium() ? ' dgora-jg-free-version' : 'dgora-jg-pro-version'; ?>">
	<h2><?php esc_html_e( 'Justified Gallery Settings', 'justified-gallery' ); ?></h2>
	<?php
	...
	<small class="dgora-jg-copy"><?php esc_html_e( 'All photos on previews are from Unsplash.com and licensed under Creative Commons Zero.', 'justified-gallery' ); ?></small>
</div>
