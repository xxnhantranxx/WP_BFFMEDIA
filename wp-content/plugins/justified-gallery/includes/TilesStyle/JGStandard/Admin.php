...
class DGWT_JG_JGStandard_Admin {
	...
	public function register_settings( $settings ) {
		...
		if ( ! dgwt_freemius()->is_premium() ) {
			$desc = sprintf( __( 'These are the default settings for the <b>%1$s</b> style. To change the following options you must <a href="%2$s">upgrade your plan</a>.', 'justified-gallery' ), __( 'JG Standard', 'justified-gallery' ), DGWT_JG_Upgrade::get_upgrade_url() );
	...
	public function prepare_preview() {
		 ...
		 */
		add_filter(
			'dgwt/jg/gallery/html_img/hover=standard',
