...
add_ux_builder_shortcode('GoiTour', array(
    'type' => 'container',
    'name'      => __('Gói Tour'),
    'category'  => __('BFF'),
    'priority'  => 21,
    ...
    'options'   => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=goi-tour">Gói Tour</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
