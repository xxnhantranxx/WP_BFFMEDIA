...
add_ux_builder_shortcode('GoiQuayVideo', array(
    'name'      => __('Gói Quay Video'),
    'category'  => __('BFF'),
    'priority'  => 19,
    'thumbnail' =>  $link_img,
    'wrap'   => false,
    ...
    'options'   => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=goi-quay-video">Gói Quay Video</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
