...
add_ux_builder_shortcode('GoiKyYeu', array(
    'type' => 'container',
    'name'      => __('Gói Kỷ Yếu'),
    'category'  => __('BFF'),
    'priority'  => 18,
    ...
    'options'   => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=goi-ky-yeu">Gói Kỷ Yếu</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
