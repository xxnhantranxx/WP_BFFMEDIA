...
add_ux_builder_shortcode( 'QuyTrinh', array(
    'name'      => __('Quy trình'),
    'category'  => __('BFF'),
    'priority'  => 29,
    'thumbnail' =>  $link_img,
    ...
    'options' => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=quy-trinh">Quy trình</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
