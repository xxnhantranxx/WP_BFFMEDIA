...
add_ux_builder_shortcode('ServiceOther', array(
    'type' => 'container',
    'name'      => __('Dịch vụ khác'),
    'category'  => __('BFF'),
    'priority'  => 7,
    'thumbnail' =>  $link_img,
    'wrap'   => false,
    ...
    'options'   => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=service-other">Dịch vụ khác</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
