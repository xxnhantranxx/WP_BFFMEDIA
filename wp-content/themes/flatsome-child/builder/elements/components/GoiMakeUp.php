...
add_ux_builder_shortcode('GoiMakeUp', array(
    'name'      => __('Gói Make Up'),
    'category'  => __('BFF'),
    'priority'  => 22,
    'thumbnail' =>  $link_img,
    ...
    'options'   => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=make-up">Gói Make Up</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
